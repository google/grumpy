...
func TestStrMethods(t *testing.T) {
	cases := []struct {
		...
		{"find", wrapArgs("foobar", NewUnicode("bar")), nil, mustCreateException(TypeErrorType, "'find' requires a 'str' object but received a 'unicode'")},
		...
		{"find", wrapArgs("foo", newTestTuple("barfoo", "oo").ToObject()), nil, mustCreateException(TypeErrorType, "'find' requires a 'str' object but received a 'tuple'")},
		{"find", wrapArgs("foo", 123), nil, mustCreateException(TypeErrorType, "'find' requires a 'str' object but received a 'int'")},
		...
		{"index", wrapArgs("foobar", NewUnicode("bar")), nil, mustCreateException(TypeErrorType, "'find' requires a 'str' object but received a 'unicode'")},
		...
		{"index", wrapArgs("foo", newTestTuple("barfoo", "oo").ToObject()), nil, mustCreateException(TypeErrorType, "'find' requires a 'str' object but received a 'tuple'")},
		{"index", wrapArgs("foo", 123), nil, mustCreateException(TypeErrorType, "'find' requires a 'str' object but received a 'int'")},
