...
func TestStrMethods(t *testing.T) {
	...
	cases := []struct {
		...
		{"isalnum", wrapArgs("123abc"), GetBool(true).ToObject(), nil},
		{"isalnum", wrapArgs(""), GetBool(false).ToObject(), nil},
		{"isalnum", wrapArgs("#$%"), GetBool(false).ToObject(), nil},
		{"isalnum", wrapArgs("123abc", "efg"), nil, mustCreateException(TypeErrorType, "'isalnum' of 'str' requires 1 arguments")},
		{"isalpha", wrapArgs("xyz"), GetBool(true).ToObject(), nil},
		{"isalpha", wrapArgs(""), GetBool(false).ToObject(), nil},
		{"isalpha", wrapArgs("#$%"), GetBool(false).ToObject(), nil},
		{"isalpha", wrapArgs("absd", "efg"), nil, mustCreateException(TypeErrorType, "'isalpha' of 'str' requires 1 arguments")},
		{"isdigit", wrapArgs("abc"), GetBool(false).ToObject(), nil},
		{"isdigit", wrapArgs("123"), GetBool(true).ToObject(), nil},
		{"isdigit", wrapArgs(""), GetBool(false).ToObject(), nil},
